...
const uint16_t PROGMEM combo_open_console[]   = {KC_G, KC_Q, COMBO_END};
...
combo_t key_combos[COMBO_COUNT] = {
    [COMBO_OPEN_CONSOLE] = COMBO(combo_open_console, OPEN_CONSOLE), [COMBO_E_R_SPACE] = COMBO(combo_e_r_space, KC_SPC), [COMBO_G_R_ENT] = COMBO(combo_g_r_ent, KC_ENT), [COMBO_H_U_ENT] = COMBO(combo_h_u_ent, KC_ENT), [COMBO_U_I_SPACE] = COMBO(combo_u_i_space, KC_SPC), [COMBO_CAPS_G_BOOT] = COMBO(combo_caps_g_boot, QK_BOOT), [COMBO_J_SCLN_COLN] = COMBO(combo_j_scln_coln, KC_COLN), [COMBO_M_N_SHIFT] = COMBO(combo_m_n_shift, KC_LSFT), [COMBO_V_B_SHIFT] = COMBO(combo_v_b_shift, KC_LSFT), [COMBO_C_V_M_COMM_CTRL] = COMBO(combo_c_v_ctrl, KC_LCTL), [COMBO_C_V_M_COMM_CTRL] = COMBO(combo_m_comm_ctrl, KC_LCTL), [COMBO_X_C_COMMA_DOT_ALT] = COMBO(combo_x_c_alt, KC_LALT), [COMBO_X_C_COMMA_DOT_ALT] = COMBO(combo_comma_dot_alt, KC_LALT), [COMBO_Z_X_DOT_SLSH_SUPER] = COMBO(combo_z_x_super, KC_LGUI), [COMBO_Z_X_DOT_SLSH_SUPER] = COMBO(combo_dot_slsh_super, KC_LGUI),
};
